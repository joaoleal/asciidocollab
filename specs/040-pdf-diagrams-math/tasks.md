...
- [X] T031 Full quality-gate sweep (`pnpm gate`: lint, typecheck, unit incl. the newly-gated asciidoc-pdf, integration, security scan, e2e) then run `/code-review` in a loop until zero findings (Constitution §End-of-Feature Verification).
