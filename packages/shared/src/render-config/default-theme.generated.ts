 ...
 *
 * A verbatim copy of asciidoctor-pdf 2.3.24's `default-theme.yml`, the file a newly created
...
export const DEFAULT_THEME_GEM_VERSION = '2.3.24';

/** The gem's default theme, byte-for-byte. */
export const DEFAULT_THEME_YAML = `font:
  catalog:
